...
{
  hid_t dataDimId = H5Gopen(file_id, H5_VTK_OBJECT_INDEX_PATH, H5P_DEFAULT);
  std::list<std::string> names;
  herr_t err = H5Vtk::H5Utilities::getGroupObjects(dataDimId, H5Vtk::H5Utilities::H5Support_DATASET,  names);
