...
public:
  ...
  */
  static MXA_EXPORT herr_t getObjectType(hid_t objId, const std::string &objName, vtkTypeInt32 *objType);
  ...
  */
  static MXA_EXPORT herr_t objectNameAtIndex(hid_t fileId, vtkTypeInt32 idx, std::string &name);
  ...
  * @return
  */
  static MXA_EXPORT herr_t getGroupObjects(hid_t loc_id, vtkTypeInt32 typeFilter, std::list<std::string>& names);
...
/**
  ...
  */
                                         ...
                                         const std::vector<uint64_t> &dims)
  {
    ...
    ptr = MXAArrayTemplate<T>::CreateMultiDimensionalArray( static_cast<vtkTypeInt32>(dims.size()), &(dims.front()));
    if (ptr.get() == NULL)
    {
...
/**
  ...
  */
                                               ...
                                               const std::vector<uint64_t> &dims)
  {
    ...
    {
      IMXAArray::Pointer attr = MXAArrayTemplate<T>::CreateMultiDimensionalArray( static_cast<vtkTypeInt32>(dims.size()), &(dims.front()));
      if (attr.get() == NULL)
      {
        return ptr; // empty attribute
      }
